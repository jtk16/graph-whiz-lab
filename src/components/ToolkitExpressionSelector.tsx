...
export function ToolkitExpressionSelector({
  ...
  const handleConfirm = () => {
    let expressionsToImport = Array.from(selected).map(i => toolkit.expressions[i]);
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <div 
                        ...
                        dangerouslySetInnerHTML={{
                          __html: `<math-field read-only style="font-size: 14px; border: none; background: transparent;">${expr.latex}</math-field>`
                        }}
                      />
                      {isImported && (
